...
type DataSources = {
  ...
  aiGenerated?: { count: number; type: string }
        ...
        <section className="text-center space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              30 real Google search keywords + 30 AI-generated keywords with search volume, difficulty, and ranking estimates.
            </p>
          </div>
          ...
          <section className="space-y-6">
            ...
            {currentDataSources && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {currentDataSources.googleAutocomplete && (
                  <Card className="bg-[#13131a] border-white/10">
                    <CardContent className="p-4">
                      ...
                      <p className="text-xs text-gray-500">real search queries from Google</p>
                    </CardContent>
                  </Card>
                )}
                ...
                {(currentDataSources.aiGenerated || currentDataSources.aiEstimates) && (
                  <Card className="bg-[#13131a] border-white/10">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2 mb-2">
                      ...
                      <p className="text-2xl font-bold text-white">{(currentDataSources.aiGenerated || currentDataSources.aiEstimates)!.count}</p>
